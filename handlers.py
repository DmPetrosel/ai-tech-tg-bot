...
async def faq(message: Message):
    await message.answer(
        ...
        reply_markup=InlineKeyboardMarkup(
            inline_keyboard=[
                [InlineKeyboardButton(text="Как начать сотрудничество?", callback_data="faq_start")],
                [InlineKeyboardButton(text="Сколько стоит разработка?", callback_data="faq_cost")],
                [InlineKeyboardButton(text="Какие технологии вы используете?", callback_data="faq_tech")],
                [InlineKeyboardButton(text="Есть ли готовые решения?", callback_data="faq_ready")],
                [InlineKeyboardButton(text="Какой срок реализации?", callback_data="faq_time")]
            ]
        ),
        parse_mode='HTML'
    )
